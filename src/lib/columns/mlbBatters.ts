...
export const BATTER_SEASON_COLUMNS: ColumnDef<BatterRow>[] = [
  {
    ...
    format: fmt.rate,
    source: MYSQL,
    definition: 'Batting average — this batter’s hits per at-bat. Ignores walks, so it understates on-base skill.',
    markets: ['Hits (O/U)'],
    sortable: true,
  },
  {
...
export const BATTER_STATCAST_COLUMNS: ColumnDef<BatterRow>[] = [
  ...
  },
  {
    ...
    format: fmt.svPct,
    source: SV,
    definition: 'Share of this batter’s batted balls hit at 95 mph or harder.',
    markets: ['Total Bases (O/U)', 'Hits (O/U)'],
    sortable: true,
  },
  {
  ...
  },
  {
    ...
    format: fmt.svPct,
    source: SV,
    definition: 'Share of this batter’s batted balls hit as line drives — the type that becomes a hit most often.',
    markets: ['Hits (O/U)'],
    sortable: true,
  },
  {
